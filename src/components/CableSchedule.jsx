...
const TO_AREAS = [
  ...
  { code: '12.1', label: '12.1 — Raw Water / Fire Water Pump House', kw: [] },
  { code: '13.4', label: '13.4 — Water Supply Pumping Station', kw: [] },
  { code: '15.1', label: '15.1 — Water Distribution Pump Station', kw: [] },
  { code: '15.4', label: '15.4-15.5 — Demineralized Water Storage Tanks', kw: [] },
  { code: '15.5', label: '15.4-15.5 — Demineralized Water Storage Tanks', kw: [] },
  ...
  { code: '23.7', label: '23.7 — Diesel Fuel Drainage Reservoir', kw: [] },
